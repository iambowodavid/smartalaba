<!DOCTYPE html>
<!-- saved from url=(0023)https://smartalaba.com/ -->
<html lang="en" class=" js cssanimations">
<head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Smart Alaba - The Future Of E-Commerce</title>

    
    <!--favicon icon-->
    <link rel="icon" href="https://smartalaba.com/static/img/favicon.png" type="image/png" sizes="16x16">

    <!-- font-awesome css -->
    <link rel="stylesheet" href="./alaba_files/font-awesome.min.css">

    <!--themify icon-->
    <link rel="stylesheet" href="./alaba_files/themify-icons.css">

    <!--flaticon icon-->
    <link rel="stylesheet" href="./alaba_files/flaticon.css">

    <!-- magnific popup css-->
    <link rel="stylesheet" href="./alaba_files/magnific-popup.css">

    <!--owl carousel -->
    <link href="./alaba_files/owl.theme.default.min.css" rel="stylesheet">
    <link href="./alaba_files/owl.carousel.min.css" rel="stylesheet">

    <!-- bootstrap core css -->
    <link href="./alaba_files/bootstrap.min.css" rel="stylesheet">

    <!-- custom css -->
    <link href="./alaba_files/style.css" rel="stylesheet">

    <!-- responsive css -->
    <link href="./alaba_files/responsive.css" rel="stylesheet">
    ...
    <script src="./alaba_files/modernizr-2.8.1.min.js"></script>
...
<body>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="navbar-header page-scroll">
                                ...
                                <a class="navbar-brand page-scroll" href="https://smartalaba.com/">
                                    <img src="./alaba_files/logo.png" alt="logo" class="img-responsive">
                                </a>
                            </div>
    ...
    <!--start hero section-->
    <section id="hero" class="section-lg section-hero section-circle" style="background: url(./alaba_files/hero-bg-1.jfif)no-repeat center center / cover">
                ...
                <div class="col-md-6">
                    <div class="hero-content-wrap">
                        <div class="hero-content">
                            <h1>Order <span style="font-size: 55px; font-style: italic; color: #fff;">ITEMS</span> from <span>Europe</span> and <span>America</span></h1>
                            <p>SmartAlaba is dedicated to buying genuine parts of all car makes and models directly from wholesalers on behalf of our customers. We also source machinery, general plant spares, equipment and consumer/household goods.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="hero-product-img">
                        <div class="hero-img-1  ">
                            <img src="./alaba_files/first_img.png" alt="hero-img" class="img-responsive">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="section-shape">
            <img src="./alaba_files/waves-shape.svg" alt="shape image">
        </div>
    </section>
    <!--end hero section-->

    
    <section id="features" class="new-features" style="padding-top: 50px; padding-bottom: 50px;">
        <?php
            $data = $_POST;
            ...
            if($data["submitted"] == "true"){
                ...
                foreach($data as $key => $value){
                    $html_inject .= "<tr><td style='font-weight:500; border:1px solid #D5D8DC; padding: 5px;'>$key</td><td style='border:1px solid #D5D8DC; padding: 5px;'>$value</td></tr>";
                }

                $html = file_get_contents("./mail-template.html");
                $html = str_replace(
                    ['{{HTML_INJECT}}'],
                    [$html_inject],
                    $html
                ...
                mail("davidbowo@gmail.com","Smartalaba contact",$html,$headers);
            }
        ?>
        <h1 align="center">Thank you for contacting us.</h1>
            ...
            <footer class="footer-section bg-secondary ptb-40" id="socio">
                                ...
                                <div class="footer-single-col text-center">
                                    <div class="footer-social-list">
                                        <ul class="list-inline">
                                            <li><a href="https://smartalaba.com/#"> <i class="fa fa-facebook"></i></a></li>
                                            <li><a href="https://smartalaba.com/#"> <i class="fa fa-twitter"></i></a></li>
                                            <li><a href="https://smartalaba.com/#"> <i class="fa fa-linkedin"></i></a></li>
                                            <li><a href="https://smartalaba.com/#"> <i class="fa fa-google-plus"></i></a></li>
                                            <li><a href="https://smartalaba.com/#"> <i class="fa fa-youtube"></i></a></li>
                                        </ul>
                                    </div>
                                    <div class="copyright-text">
                                        <p>© copyright <a href="https://smartalaba.com/#">Smartalaba</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
...
<div class="footer-new" style="z-index: 5">
    <div class="menu-bar">
        <ul>    
            <li><a href="https://smartalaba.com/#main" title="Home"><i class="fa fa-home"></i></a></li>
            <li><a href="https://smartalaba.com/#why-us" title="Social"><i class="fa fa-handshake-o"></i></a></li>
            <li><a href="https://smartalaba.com/#features" title="How It Works"><i class="fa fa-cogs"></i></a></li>
            <li><a href="https://smartalaba.com/#faqs" title="Faq"><i class="fa fa-question-circle"></i></a></li>
            <li><a href="https://smartalaba.com/reach-us/" title="Contact"><i class="fa fa-address-book"></i></a></li>
    ...
    <!-- main jQuery -->
    <script src="./alaba_files/jquery-3.3.1.min.js"></script>

    <!-- bootstrap core js -->
    <script src="./alaba_files/bootstrap.min.js"></script>

    <!-- smothscroll -->
    <script src="./alaba_files/jquery.easeScroll.min.js"></script>

    <!--owl carousel-->
    <script src="./alaba_files/owl.carousel.min.js"></script>

    <!-- scrolling nav -->
    <script src="./alaba_files/jquery.easing.min.js"></script>

    <!--magnific popup js-->
    <script src="./alaba_files/magnific-popup.min.js"></script>

    <!-- custom script -->
    <script src="./alaba_files/scripts.js"></script>
